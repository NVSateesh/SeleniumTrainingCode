...
public class CustomCompareUtil {
	...
	/**
	   ...
	   public static List<Map<String, Object>> readRows(ResultSet resultSet_) throws SQLException {
		   ...
		   public static List<String> readColumnNames(ResultSet resultSet_) throws SQLException {
			      return readColumnNames(resultSet_, false);
			   }
		   
		   public static List<String> readColumnNames(ResultSet resultSet_, boolean keysUpper_)
				      throws SQLException {
				      if (resultSet_ == null)
				         return null;
				      SQLWarning warnings = resultSet_.getWarnings();
				      ...
				      return Lists.newArrayList(columnNames);
				   }
}
